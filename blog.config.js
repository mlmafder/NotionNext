...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'mlmafder', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个流浪在互联网世界的普通人', // 作者简介
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一个流浪在互联网世界的普通人', // 站点描述，被notion中的页面描述覆盖
